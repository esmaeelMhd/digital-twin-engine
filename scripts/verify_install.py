...
def verify_dte_modules():
    ...
    modules = [
        ...
        "dte.data.generation",
        "dte.data.datasets.unit_dataset",
        "dte.models.unit.encoder",
        "dte.models.unit.decoder",
        "dte.models.unit.latent_sde",
        "dte.models.unit.digital_twin",
        "dte.physics.conservation",
        "dte.physics.heat_exchanger",
        "dte.physics.two_tank",
        "dte.control.pid",
        "dte.control.mpc",
        "dte.training.unit.trainer",
        "dte.training.shared.losses",
